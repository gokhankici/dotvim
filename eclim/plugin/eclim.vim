...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/gokhan/.eclipse/org.eclipse.platform_4.2.0_185596441/plugins/org.eclim_2.2.2'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/gokhan/.eclipse/org.eclipse.platform_4.2.0_185596441'
  if has('win32unix')
